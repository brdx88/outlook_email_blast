...
for recipient in recipients:
    if recipient['flag'] != 'sent':
        ...
        <body>
            ...
            <p>I'm passionate about helping companies like {recipient['company_name']} harness the power of data to drive innovation. 
        ...
        try:
            send_email(recipient['email'], f"Excited to Explore a Part-Time Remote Opportunity at {recipient['company_name']}", email_body)
